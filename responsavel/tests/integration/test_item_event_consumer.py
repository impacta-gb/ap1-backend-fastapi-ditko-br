"""
Testes para ItemEventConsumer do módulo Responsável
"""
import pytest
from unittest.mock import AsyncMock
from responsavel.src.infrastructure.messaging.consumers.item_event_consumer import ItemEventConsumer


class TestResponsavelItemEventConsumer:
    """Testes para ItemEventConsumer (Responsável)"""
    ...
    async def test_consumer_initialization(self):
        ...
        assert consumer.group_id == 'responsavel_item_listener_group'
