...
class DevolucaoBase(BaseModel):
    ...
    reclamante_id: int = Field(..., gt=0, description="ID do reclamante")
    item_id: int = Field(..., gt=0, description="ID do item devolvido")
...
class DevolucaoPatch(BaseModel):
    ...
    reclamante_id: Optional[int] = Field(None, gt=0, description="ID do reclamante")
    item_id: Optional[int] = Field(None, gt=0, description="ID do item devolvido")
